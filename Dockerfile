...
RUN wget http://nginx.org/packages/mainline/centos/7/SRPMS/nginx-1.13.9-1.el7_4.ngx.src.rpm -O /root/rpmbuild/SRPMS/nginx-1.13.9-1.el7_4.ngx.src.rpm
...
RUN rpm -Uvh /root/rpmbuild/SRPMS/nginx-1.13.9-1.el7_4.ngx.src.rpm
